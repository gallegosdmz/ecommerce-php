                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 ...
                                 <th><i class="icon_calendar"></i> Apellido</th>
                                 <th><i class="icon_calendar"></i> Grado</th>
                                 <th><i class="icon_mobile"></i> Grupo</th><th>
                                 <i class="icon_pin_alt"></i> Telefono</th>
                                 <th><i class="icon_genius"></i> Encuentro</th>
                                 <th><i class="icon_cogs"></i> Compras</th>
                              ...
                              <tr>
                                ...
                                <td><?php echo $mostrar['encuentro'] ?></td>
                                <td><a class="btn btn-danger" href="carrito.php" value="Listar Datos Capturados"  ">Compras</a></td>
                                <td>
                                  <div class="btn-group">
                                      <a class="btn btn-success" href="eliminarPedidos.php?id=<?php echo $mostrar['id'] ?>"><i class="icon_check_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
