                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              <tr>
                                 ...
                                 <th><i class="icon_calendar"></i> Grupo</th>
                                 <th><i class="icon_mobile"></i> Telefono</th>
                                 <th><i class="icon_genius"></i> Queja</th>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="btn-group">
                                      <a class="btn btn-danger" href="eliminarReportes.php?id=<?php echo $mostrar['id'] ?>"><i class="icon_close_alt2"></i></a>
                                  </div>
                                  </td>
                              </tr>
